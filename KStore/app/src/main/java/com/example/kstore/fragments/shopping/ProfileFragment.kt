...
import com.example.kstore.activities.LoginRegisterActivity
import com.example.kstore.databinding.FragmentProfileBinding
import com.example.kstore.util.Resource
import com.example.kstore.util.showBottomNavigationView
import com.example.kstore.viewmodel.ProfileViewModel
...
class ProfileFragment: Fragment(R.layout.fragment_profile) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.linearLogOut.setOnClickListener {
            ...
            requireActivity().finish() /* Removing the activity from the backStack */
            ...
            viewModel.user.collectLatest{
                when(it){
                    ...
                    is Resource.Success -> {
                        ...
                        Glide.with(requireContext()).load(it.data!!.imagePath).error(ColorDrawable(
