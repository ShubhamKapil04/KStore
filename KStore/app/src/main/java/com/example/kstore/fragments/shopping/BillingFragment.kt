...
import com.example.kstore.adapters.AddressAdapter
...
import com.example.kstore.databinding.FragmentBillingBinding
import com.example.kstore.util.HorizontalItemDecoration
import com.example.kstore.util.Resource
import com.example.kstore.viewmodel.BillingViewModel
import com.example.kstore.viewmodel.OrderViewModel
...
class BillingFragment: Fragment() {
    ...
    private fun showOrderConfirmationDialog() {
        val alertDialog = AlertDialog.Builder(requireContext()).apply {
            ...
            setMessage("Do you want to orders your cart Items?")
